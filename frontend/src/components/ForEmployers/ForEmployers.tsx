  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 py-[200px] dark:bg-black">
      ...
      <Link href={`/za-delodajalce/registracija`}>
        <div className="flex flex-1 flex-col items-center rounded-lg bg-white p-10 shadow-md md:flex-row transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-indigo-50 dark:bg-dark dark:shadow-none" style={{ height: "240px" }}>
          <div className="mb-4 flex w-full items-center justify-center md:mb-0 sm:w-1/3">
            <img

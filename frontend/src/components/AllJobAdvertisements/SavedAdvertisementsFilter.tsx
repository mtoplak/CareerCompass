...
const SavedJobAdvertisementsFilter = ({ isSavedPage }: { isSavedPage: boolean }) => {
  ...
  return (
    <form action="#">
      <section
        id="saved-jobs"
        className="bg-gray-1 pt-4 dark:bg-dark-2 flex flex-col items-center"
      >
        {session?.user && (
          <button 
            type="button"
          ...
          >
            <div className="flex items-center justify-center">
              <span>
                {isSavedPage ? 'Prikaži vse zaposlitvene oglase' : 'Prikaži shranjene zaposlitve'}
              </span>
            </div>
          </button>
        )}

...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-indigo-950 pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                Oblikujemo prihodnost dela z omogočanjem ocenjevanja
                delodajalcev in odkrivanjem zaposlitvenih priložnosti.
              </p>
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start"></div>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-gray-7">Created by kMET.</p>
              </div>
            </div>
          </div>
        </div>

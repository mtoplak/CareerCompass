          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/4 lg:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="http://localhost:3000/podjetja"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/4 lg:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="http://localhost:3000/prijava"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                    Prijava
                  </a>
                ...
                <li>
                  <a
                    href="http://localhost:3000/registracija"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                    Registracija
                  </a>
      ...
      <div className="mt-12 border-t border-[#8890A4] border-opacity-40 py-8 lg:mt-[60px]">
        <div className="container">
          <div className="flex justify-end">
            <div className="text-base text-gray-7">Created by kMET.</div>
          </div>
        </div>
      </div>
